...
public class PointSpawnDogController : ErshenMonoBehaviour
{
    ...
    protected virtual void Spawn()
    {
        ...
        float scaleValue = waveDogSO.waves[wave].phases[phase].levelDogs[levelDog].scaleValue;
        foreach (PointSpawnDog pointSpawnDog in listPointSpawnDog)
        {
            ...
            {
                StartCoroutine(listPointSpawnDog[index - 1].Spawning(dogName, timeDelay, hpDogMax, damageDog, scaleValue));
            }
        }
    }
