...
public class CanvasSpawner : ErshenMonoBehaviour
{
    protected static CanvasSpawner instance;
    public static CanvasSpawner Instance => instance;
